...
class AmbushCommander(Commander):
    ...
    #With current callback function, favors squares closer to the enemy that cannot be seen.
    #TODO change the call back, and change the initial visibility screening to entirely change how a square is analyzed.
    ...
    def calculateAmbushes(self):        
        ...
        for i in range(500):  # NOTE: you must feed in better pre-selected positions (eg near boxes) to get good results with this number of iterations.
            ...
            #Square actually just squares. Get distance gets distance of shortest path to enemyflag. Visibilities.pixel(xcoord,ycoord) returns an amount seen int.
